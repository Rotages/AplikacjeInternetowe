...
final class MeasurementController extends AbstractController {
    ...
    #[Route('/city/{city}', name: 'app_measurement_by_city', methods: ['GET'])]
    public function indexByCity(string $city, MeasurementRepository $measurementRepository): Response
    {
        $measurements = $measurementRepository->findByCity($city); // Assuming findByCity is defined
